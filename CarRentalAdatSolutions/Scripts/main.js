...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $("#slideslow-bg").vegas({
            ...
            slides: [
                {
                    src: '../Content/img/slider-img/slider-img-1.jpg'
                },
                {
                    src: '../Content/img/slider-img/slider-img-2.jpg'
                },
                {
                    src: '../Content/img/slider-img/slider-img-3.jpg'
                },
                {
                    src: '../Content/img/slider-img/slider-img-4.jpg'
                }
            ]
        }); //Home Page Two Slideshow
